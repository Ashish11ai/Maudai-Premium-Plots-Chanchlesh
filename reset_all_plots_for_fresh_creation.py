...
# Save data/plots.json with approved=False and no prebuilt meshes
...
# Write clean public/js/plotData.js
js_content = f"""/**
 * Plot Data Definitions for Maudai Premium Plots
 * Fresh Canvas Mode - Ready for User Plot Creation
 */
...
print("Successfully cleared all plot meshes! Clean layout plan ready for creation!")
