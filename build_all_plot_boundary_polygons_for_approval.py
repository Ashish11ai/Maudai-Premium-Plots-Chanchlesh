...
for num in range(1, 97):
    ...
    # Sector rotation and dimensions
    if num in [1, 2, 3, 4, 5, 6, 33, 34, 35]:
        ...
        rot_deg = -42.0
        if num == 7: w_ft, d_ft = 30.0, 52.1
        elif num == 8: w_ft, d_ft = 30.0, 56.8
    ...
    # 4 rotated polygon corner points
    ...
    plots_json_data[str_num] = {
        ...
        'price': 0,
        'notes': '',
        'approved': False, # Pending approval for 1-by-1 user approval
        'polygon': poly,
 ...
 * 2D Boundary Lines Mode for 1-by-1 Plot Approval
 */
...
print(f"Successfully generated 2D boundary polygons for all {len(plot_polygons_exact)} plots! Ready for 1-by-1 user approval!")
